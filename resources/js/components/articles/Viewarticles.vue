...
<template>
    ...
    <router-link :to="{name: 'Addarticles'}" class="btn btn-outline-light">
...
<td>
<router-link :to="{name: 'editarticle', params: { id: art.id }}" class="btn btn-outline-warning mx-2"><!-- bch nmodifie via une route /12 !-->
